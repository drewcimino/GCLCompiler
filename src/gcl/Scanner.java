...
public class Scanner {
	...
	static {
		...
		literals.put("typedefinition", new Integer(13));
		literals.put("procedure", new Integer(14));
		literals.put("array", new Integer(16));
		literals.put("range", new Integer(19));
		literals.put("integer", new Integer(21));
		literals.put("Boolean", new Integer(22));
		literals.put("tuple", new Integer(23));
		literals.put("value", new Integer(26));
		literals.put("reference", new Integer(27));
		...
		literals.put("od", new Integer(35));
		literals.put("forall", new Integer(36));
		literals.put("llarof", new Integer(38));
		literals.put("if", new Integer(39));
		literals.put("fi", new Integer(40));
		literals.put("true", new Integer(55));
		literals.put("false", new Integer(56));
