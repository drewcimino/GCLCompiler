...
// GCL Version 2011
	...
	public static final int _option1 = 45;
	public static final int _option3 = 46;
	public static final int _option5 = 47;
	public static final int _option6 = 48;
	public static final int _option7 = 49;
	public static final int _option9 = 50;
	public static final int _option10 = 51;
...
/*==========================================================*/
	...
	void gcl() {
		...
		while (!(la.kind == 0 || la.kind == 4)) {SynErr(45); Get();}
		module(scope);
		while (la.kind == 4) {
	...
	private boolean[][] set = {
		{T,T,x,x, T,x,x,T, x,x,x,T, T,T,x,x, T,T,T,x, T,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{T,x,x,x, x,x,x,x, x,x,x,T, T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{T,T,x,x, T,T,T,T, x,x,x,T, T,T,x,x, T,T,T,x, T,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,x, T,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{T,T,x,x, T,x,x,T, T,x,x,T, T,T,x,x, T,T,T,x, T,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,x, T,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x},
		{x,T,T,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,T, x,x,x,x, x,x,x,x, x,x,T,T, x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,T,T,x, x,x,x,x, x,x},
		{x,T,T,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,T, x,x,x,x, x,x,x,x, x,x,T,T, x,x}
...
class Errors {
	...
	public void SynErr (int line, int col, int n) {
			...
			case 13: s = "\"tuple\" expected"; break;
			...
			case 47: s = "this symbol not expected in definitionPart"; break;
			case 48: s = "this symbol not expected in block"; break;
			...
			case 53: s = "invalid typeSymbol"; break;
			case 54: s = "invalid writeItem"; break;
			case 55: s = "invalid simpleExpr"; break;
			case 56: s = "invalid relationalOperator"; break;
			case 57: s = "invalid addOperator"; break;
			case 58: s = "invalid factor"; break;
			case 59: s = "invalid multiplyOperator"; break;
			case 60: s = "invalid booleanConstant"; break;
