...
..\sam3-pc.exe 
java -cp . macc.Macc3 >..\tests\results\sam\test7_sam.result

java -cp . gcl.GCLCompiler ..\tests\test8 ..\tests\results\sam\test8list.txt
..\sam3-pc.exe 
java -cp . macc.Macc3 >..\tests\results\sam\test8_sam.result

java -cp . gcl.GCLCompiler ..\tests\test9 ..\tests\results\sam\test9list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test9.dat >..\tests\results\sam\test9_sam.result

java -cp . gcl.GCLCompiler ..\tests\test9_1 ..\tests\results\sam\test9_1list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test9_1.dat >..\tests\results\sam\test9_1_sam.result

java -cp . gcl.GCLCompiler ..\tests\test9_2 ..\tests\results\sam\test9_2list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test9_2_sam.result
...
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test10_1_sam.result
...
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_sam.result

java -cp . gcl.GCLCompiler ..\tests\test11_1 ..\tests\results\sam\test11_1list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_1_sam.result

java -cp . gcl.GCLCompiler ..\tests\test11_2 ..\tests\results\sam\test11_2list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_2_sam.result

::java -cp . gcl.GCLCompiler ..\tests\test11_3 ..\tests\results\sam\test11_3list.txt
..\sam3-pc.exe
::java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_3_sam.result

java -cp . gcl.GCLCompiler ..\tests\test11_3.fix ..\tests\results\sam\test11_3fixlist.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_3fix_sam.result

java -cp . gcl.GCLCompiler ..\tests\test11_4 ..\tests\results\sam\test11_4list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_4_sam.result

java -cp . gcl.GCLCompiler ..\tests\test11_5 ..\tests\results\sam\test11_5list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_5_sam.result

java -cp . gcl.GCLCompiler ..\tests\test11_6 ..\tests\results\sam\test11_6list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_6_sam.result
...
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test11_8_sam.result

java -cp . gcl.GCLCompiler ..\tests\test11_9 ..\tests\results\sam\test11_9list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test11.dat >..\tests\results\sam\test11_9_sam.result

java -cp . gcl.GCLCompiler ..\tests\test12 ..\tests\results\sam\test12list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test12_sam.result

java -cp . gcl.GCLCompiler ..\tests\test12_1 ..\tests\results\sam\test12_1list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test12_1_sam.result
...
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test13.dat >..\tests\results\sam\test13_sam.result

java -cp . gcl.GCLCompiler ..\tests\test13_1 ..\tests\results\sam\test13_1list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test13.dat >..\tests\results\sam\test13_1_sam.result

java -cp . gcl.GCLCompiler ..\tests\test14 ..\tests\results\sam\test14list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test14_sam.result

java -cp . gcl.GCLCompiler ..\tests\test14_1 ..\tests\results\sam\test14_1list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test14_1.dat >..\tests\results\sam\test14_1_sam.result

java -cp . gcl.GCLCompiler ..\tests\test15 ..\tests\results\sam\test15list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test15.dat >..\tests\results\sam\test15_sam.result

java -cp . gcl.GCLCompiler ..\tests\test16 ..\tests\results\sam\test16list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test16_sam.result
...
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test16_2.dat >..\tests\results\sam\test16_2_sam.result

java -cp . gcl.GCLCompiler ..\tests\test16_3 ..\tests\results\sam\test16_3list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test16_3_sam.result

java -cp . gcl.GCLCompiler ..\tests\test17 ..\tests\results\sam\test17list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test17.dat >..\tests\results\sam\test17_sam.result

java -cp . gcl.GCLCompiler ..\tests\test17_1 ..\tests\results\sam\test17_1list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test17_1.dat >..\tests\results\sam\test17_1_sam.result

java -cp . gcl.GCLCompiler ..\tests\test17_2 ..\tests\results\sam\test17_2list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test17_2_sam.result

java -cp . gcl.GCLCompiler ..\tests\test17_3 ..\tests\results\sam\test17_3list.txt
..\sam3-pc.exe
java -cp . macc.Macc3 <..\tests\test17_3.dat >..\tests\results\sam\test17_3_sam.result
...
..\sam3-pc.exe
java -cp . macc.Macc3 >..\tests\results\sam\test20_1_sam.result
